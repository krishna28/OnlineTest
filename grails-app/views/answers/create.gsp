...
<html>
	...
	<body>
		<a href="#create-answers" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-answers" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:answersInstance, action:'save']" >
				<fieldset class="form">
